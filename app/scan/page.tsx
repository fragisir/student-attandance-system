  ...
  if (status === 'idle') {
    return (
      <motion.div 
        ...
        className="w-full max-w-sm md:max-w-md mx-auto space-y-8 glass p-8 md:p-10 rounded-3xl"
      >
        <div className="text-center space-y-3">
          <div className="w-20 h-20 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-3xl flex items-center justify-center mx-auto mb-2 shadow-sm">
            <School className="w-10 h-10" />
          </div>
          <h1 className="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white leading-tight">出席を記録</h1>
          <p className="text-base md:text-lg text-slate-500 dark:text-slate-400 font-medium">詳細を入力してください。</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-5">
            <div className="space-y-2.5">
              <label className="text-xs md:text-sm font-bold text-slate-400 uppercase tracking-widest flex items-center gap-2 px-1">
              ...
              <input 
                ...
                className="w-full px-5 py-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all outline-none text-lg font-medium"
              />
            </div>

            <div className="space-y-2.5">
              <label className="text-xs md:text-sm font-bold text-slate-400 uppercase tracking-widest flex items-center gap-2 px-1">
                <School className="w-4 h-4 text-primary" /> クラスを選択
              </label>
              <div className="relative">
                <select 
                  ...
                  className="w-full px-5 py-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all outline-none text-lg font-medium appearance-none cursor-pointer"
                >
          ...
          <button 
            type="submit"
            className="w-full py-5 bg-primary hover:bg-primary/90 text-white text-lg font-bold rounded-2xl shadow-xl shadow-primary/20 hover:shadow-primary/30 active:scale-[0.98] transition-all flex items-center justify-center gap-3 group"
          >
            出席を送信
